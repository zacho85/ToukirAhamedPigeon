...
export default function WalletBalance({ user, stats }: { user: any, stats: any }) {
  ...
  return (
    ...
    <div className="grid gap-6 md:grid-cols-2">
      {/* Main Balance Card */}
      <Card className="overflow-hidden bg-linear-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
        <CardContent className="p-8">
          ...
          <div className="flex justify-between pt-6 border-t border-white/20">
            ...
            <div className="text-right">
                ...
                <p className="text-xl font-semibold mt-1">{user?.rewardsPoints || 0}</p>
            </div>
        </div>
        </CardContent>
      </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Money In</p>
                  <p className="text-xl font-bold text-slate-900 dark:text-slate-100">${stats.moneyIn.toFixed(2)}</p>
                </div>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Money Out</p>
                  <p className="text-xl font-bold text-slate-900 dark:text-slate-100">${stats.moneyOut.toFixed(2)}</p>
                </div>
              </div>
