...
import { createTransaction } from '@/modules/dashboard/api/transactions';
...
export default function AddMoneyDialog({ isOpen, onClose, onMoneyAdded, user }: Props) {
  const [amount, setAmount] = useState('');
  const [isProcessing, setIsProcessing] = useState(false);
  const dispatch = useDispatch();

  const handleAddMoney = async (method:string) => {
